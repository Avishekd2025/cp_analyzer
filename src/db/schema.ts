...
export const segmentProblems = pgTable("segment_problems", {
  id: text("id").primaryKey(),
...
export const solutionEvidence = pgTable("solution_evidence", {
  id: text("id").primaryKey(),
  problemId: text("problem_id").notNull().references(() => problems.id),
...
export const techniqueCombinations = pgTable("technique_combinations", {
  id: text("id").primaryKey(),
...
export const problemKnowledge = pgTable("problem_knowledge", {
  id: text("id").primaryKey(),
  problemId: text("problem_id").notNull().references(() => problems.id),
...
export const representativeProblems = pgTable("representative_problems", {
  id: text("id").primaryKey(),
  patternId: text("pattern_id").notNull().references(() => patterns.id),
  problemId: text("problem_id").notNull().references(() => problems.id),
...
export const patternAliases = pgTable("pattern_aliases", {
  id: text("id").primaryKey(),
  patternId: text("pattern_id").notNull().references(() => patterns.id),
